...
public class TinyDB {
    ...
    private String IS_PURCHASED_GPS_TOOLS="IS_PURCHASED_GPS_TOOLS";
    ...
    public boolean isAppPurchased() {
        return preferences.getBoolean(IS_PURCHASED_GPS_TOOLS, false);
    }
...
//    }
    ...
    public void putInAppPurchases(boolean value) {
        checkForNullKey(IS_PURCHASED_GPS_TOOLS);
        preferences.edit().putBoolean(IS_PURCHASED_GPS_TOOLS, value).apply();
    }
